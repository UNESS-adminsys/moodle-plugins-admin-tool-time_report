...
$string['settings:available_on_admins_desc'] = 'Rendre la génération de rapport possible sur son profil en tant qu\'admin. Expérimental.';
...
$string['cachedef_selectoptions'] = 'Cache pour les valeurs unique de la table logstore';
