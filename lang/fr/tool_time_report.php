...
$string['cachedef_selectoptions'] = 'Cache pour les valeurs uniques de la table logstore';
...
$string['no_results_found'] = 'Aucune donnée de connexion exploitable pour cette période';
...
$string['settings:available_on_admins'] = 'Accessible sur les profils admins (Expérimental)';
$string['settings:available_on_admins_desc'] =
    'Rendre la génération de rapport possible sur son profil en tant qu\'admin. Expérimental.';
...
$string['settings:calculation_rule_text'] =
    "Définir le texte utilisé pour expliquer comment le rapport est généré. Utilisez {i} et {b} pour symboliser les variables 'idletime' et 'borrowedtime'.";
...
$string['settings:logo_desc'] = 'Logo dans l\'entête du rapport généré';
$string['settings:name_view_table'] = 'Nom de la vue';
$string['settings:name_view_table_desc'] = 'Nom de la vue sql pour les logs';
...
$string['settings:use_view_table'] = 'Utiliser une vue pour les logs';
$string['settings:use_view_table_desc'] = 'S\'il y a plusieurs tables sql de logs, permet de prendre les données dans une vue SQL';
...
$string['university_not_specified'] = 'Non-renseigné';
